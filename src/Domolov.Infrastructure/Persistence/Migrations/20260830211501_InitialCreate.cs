...
namespace Domolov.Infrastructure.Persistence.Migrations
{
    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SearchUrl = table.Column<string>(
                        type: "character varying(2000)",
                        maxLength: 2000,
                        nullable: false
                    ),
                    Cron = table.Column<string>(
                    ...
                    LastScannedAt = table.Column<DateTimeOffset>(
                        type: "timestamp with time zone",
                        nullable: true
                    ),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    QueuedAt = table.Column<DateTimeOffset>(
                        type: "timestamp with time zone",
                        nullable: false
                    ),
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.DropTable(name: "PriceObservations");

            migrationBuilder.DropTable(name: "PushSubscriptions");

            migrationBuilder.DropTable(name: "ScanRuns");

            migrationBuilder.DropTable(name: "WatchSightings");

            migrationBuilder.DropTable(name: "Listings");

            migrationBuilder.DropTable(name: "Watches");
        }
    }
}
